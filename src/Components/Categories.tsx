        ...
        <>
            ...
            <div className="grid grid-cols-4 gap-4 textFont uppercase text-lg Audiowide py-4 w-full  xl:px-36 2xl:px-40 md:px-16 lg:px-20 sm:px-14 px-4">
                ...
                <div className='row-span-2 backgroundArctic relative  text-left rounded-xl cursor-pointer'  >
                    <a href="/my-yad2yokra-app/shop/bags" className='' >
                        <img src="/my-yad2yokra-app//categoriesImgs/bagsCategory.png" alt="" className='absolute xl:top-10 xl:right-3 right-2 top-5 xl:w-70  h-20 lg:w-48 lg:h-32 lg:ml-8 sm:w-32 sm:h-20 xl:w-[300px] xl:h-[170px] ' />
                ...
                <div className='backgroundArctic relative text-left rounded-xl 2xl:py-20 px-4 xl:py-20  lg:py-16 py-10'>
                    <a href='/my-yad2yokra-app/shop/wallets' title='wallets' className=''>
                        <img src="/my-yad2yokra-app/categoriesImgs/walletsCategory.png" alt="" className=' absolute top-3 right-0 w-26 h-12 xl:w-[200px] xl:h-[130px] lg:w-32 lg:h-24 md:w-24 md:h-16  sm:w-16  ' />
                ...
                <div className='backgroundArctic relative pt-4 text-left rounded-xl  px-2  py-10'>
                    <a href='/my-yad2yokra-app/shop/accessories' title='accessories'  >
                        <img src="/my-yad2yokra-app/categoriesImgs/accessoriesCategory.png" alt="" className=' absolute w-16 top-5 md:top-2 right-0 xl:top-8 lg:-right-3 lg:top-6 mb-5 h-8 sm:w-16 md:w-24 md:h-16 xl:w-64 xl:h-24 lg:w-36 lg:h-20' />
                ...
                <div className='backgroundArctic relative text-left rounded-xl pt-0 px-4 xl:py-14 py-10'>
                    <a href='/my-yad2yokra-app/shop/shoes' title='shoes' >
                        <img src="/my-yad2yokra-app/categoriesImgs/shoesCategory.png" alt="" className='absolute  xl:top-1 lg:right-2 lg:top-1 right-0 mt-4 -mb-2 xl:w-52 sm:w-16  xl:h-32 lg:w-36 lg:h-24 w-14 h-14 md:w-24 md:h-16 ' />
                ...
                <div className='backgroundArctic relative text-left rounded-xl 2xl:py-20 xl:py-20 px-4  lg:py-16 py-10'>
                    <a href='/my-yad2yokra-app/shop/clothing' title='clothing' className=''>
                        <img src="/my-yad2yokra-app/categoriesImgs/clothingCategory1.png" alt="" className=' absolute  top-2 right-0 xl:right-3 xl:w-28 xl:h-36 lg:w-36 lg:h-24 w-14 h-12 md:w-24 md:h-16' />
                ...
                <div className='backgroundArctic relative pt-6 text-left rounded-xl px-4 xl:py-14 py-10'>
                    <a href='/my-yad2yokra-app/shop/watches' title='watches' >
                        <img src="/my-yad2yokra-app/categoriesImgs/watchesCategory.png" alt="" className='absolute xl:top-5 right-2 md:top-5 top-3  xl:w-52 xl:h-32 lg:w-36 lg:h-24 h-12 md:w-24 md:h-12 ' />
                ...
                <div className='backgroundArctic relative pt-6 text-left rounded-xl px-4 xl:py-14 py-10'>
                    <a href='/my-yad2yokra-app/shop/jewellery' title='jewellery' >
                        <img src="/my-yad2yokra-app/categoriesImgs/jewelleryCategory.png" alt="" className='absolute top-6 right-4 xl:top-8 lg:top-9 -mt-4 mb-1 xl:w-44 xl:h-32 w-12 h-12 lg:w-28 lg:h-20 md:w-20 md:h-16' />
