    ...
    return (
        <>
            <div className='SquareRegular relative w-full flex items-center justify-between py-2'>
                <a href='/my-yad2yokra-app' >
                    <img src={logo} alt="logoImage" className='md:h-20 h-14 mt-2' />
                </a>
                <div className='hidden sm:flex mt-4  absolute left-72  '>
                    <a className='mr-4 xl:mr-14 xl:-ml-10 lg:-ml-28 md:-ml-32 -ml-40 lg:mr-10 hover:text-[#f4c860] xl:text-2xl lg:text-xl md:text-lg sm:text-base' href='/my-yad2yokra-app/shop'>Shop</a>

                    <a className='mr-4 xl:mr-14 lg:mr-10 hover:text-[#f4c860]  xl:text-2xl lg:text-xl md:text-lg sm:text-base ' href='/my-yad2yokra-app/contactus'>Contact-Us</a>
                    <a className='hover:text-[#f4c860]  xl:text-2xl lg:text-xl md:text-lg sm:text-base' href='/my-yad2yokra-app/about'>About</a>
                </div>
                ...
                <div className='-ml-10 flex text-center group'>
                    <a className='mr-2 mt-1 absolute top-9 md:top-12 right-11 z-10 ' href='/my-yad2yokra-app/signin' >
                        <FaUser />
                    </a>
                    <div className='log invisible  group-hover:visible border-black border rounded-lg sm:w-24 md:w-24 lg:w-32 sm:right-[48px] right-[58px]  sm:h-10 bg-gray-500 sm:top-8 md:top-11 absolute'>
                        <a className='mr-2 hidden sm:block sm:text-[14px] w-16 group' href='/my-yad2yokra-app/signin'>
                ...
                <div className={`sm:hidden backgroundArctic -z-10 fixed top-20  flex flex-col items-center h-full w-full text-xl space-y-3  ${!isOpen ? "-translate-y-full" : "translate-y-0"} ease-in-out duration-700`}>
                    ...
                    <a className="pt-28" href='/my-yad2yokra-app/shop'>Shop</a>
                    <a className="" href='/my-yad2yokra-app/contactus'>Contact</a>
                    <a className="" href='/my-yad2yokra-app/about'>About</a>
                    <a className="" href="/my-yad2yokra-app/privacy-policy">Privacy-Policy</a>
